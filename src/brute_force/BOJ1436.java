...
public class BOJ1436 {
    public static void main(String[] args) throws IOException {
        ...
        while(count<=n) {
            System.out.println(count+" : "+ans); //59666
            if((ans-666)%10==0) { //666으로 끝날때
                System.out.println(ans+"if문 거침");
                    ...
                    //6이 4개이상이면
                //**
                    if (temp.replace("666", "").contains("6")) { //60
                        ...
                        if(temp.replace("666", "").charAt(temp.replace("666", "").length()-1)=='6') {
                            for (int j=0; j<d; j++) {
                                minus = minus +6*(int)Math.pow(10,j);
                            }
                        ans-=minus;
                            //**--
                            for (int i = 0; i < Math.pow(10,d); i++) {
...
//                        } else {
//                            for(int i = 0; i<Math.pow(9, temp.replace("666", "").length()); i++) {
//                                System.out.println(count + " : " + ans);
//                                ans++;
//                            }
//
